...
public class SettingsForm : Form
{
    ...
    public SettingsForm(AppConfig config)
    {
        ...
        var btnSave = new Button { Text = "Guardar", Location = new Point(255, 400), DialogResult = DialogResult.OK };
        Controls.Add(btnSave);

        var btnCancel = new Button { Text = "Cancelar", Location = new Point(340, 400), DialogResult = DialogResult.Cancel };
